...
str=[' -';' :';'--'; '-.'];
mkr = ['o';'+';'s';'^';'*';'d'];
pathname_tmp = 'F:\Research\MyPaper\GenQSGD_Journal\Simulation\F_Hetero_opt\Tmp\';
pathname_data = 'F:\Research\MyPaper\GenQSGD_Journal\Simulation\F_Hetero_opt\Data\';
rand_stop = 20;
...
% ------------ Plot 1 ---------
p1 = plot(F_ratio_list, energy_line_Gen);
...
% ------------ Plot 1 ---------
p1 = semilogy(F_ratio_list, energy_line_Gen);
%         p2 = loglog(F_ratio_list, energy_line_Gen);
p1.Color = clr(1, :);
p1.LineStyle = str(1, :);
p1.Marker = mkr(1, :);
...
%         p1 = loglog(F_ratio_list, energy_line_PM);
p2.Color = clr(2, :);
p2.LineStyle = str(2, :);
p2.Marker = mkr(2, :);
p2.MarkerSize = 10;
