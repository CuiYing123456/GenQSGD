function [J_opt, J_epoch, Acc_opt, Accuracy_epoch, epoch_end, IsOverflow] ...
    = GlobalTrain_cons( num_labels, img_train, lab_train, img_test, lab_test, ...
    img_train_num, row_num, col_num, local_batch_size, ...
    input_layer_size, hidden_layer_size, ...
    E, N, step1, step2, B, gamma_C, lambda,...
...
for k=1 : E
    ...
    for i=1 : floor(N/2)
        [local_Theta1, local_Theta2] = LocalTrain( Theta1_avg, Theta2_avg, ...
            ...
            local_img(:, :, i), local_lab(:, i), B, step1, gamma_C, lambda, k);
    ...
    for i= floor(N/2) + 1 : N
        [local_Theta1, local_Theta2] = LocalTrain( Theta1_avg, Theta2_avg, ...
            input_layer_size, hidden_layer_size, num_labels, ...
            local_img(:, :, i), local_lab(:, i), B, step2, gamma_C, lambda, k);
        Theta1_accu = Theta1_accu + local_Theta1;
        Theta2_accu = Theta2_accu + local_Theta2;
    end
    % global averaging
