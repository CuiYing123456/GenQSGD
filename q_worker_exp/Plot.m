...
line2=loglog(bits_list(2:end), energy_line_exp(2:end),'r--o',bits_list(2:end), energy_line_PM_fix(2:end),'b--+',bits_list(2:end), energy_line_FedAvg_fix(2:end),'g--s',bits_list(2:end), energy_line_PR_fix(2:end),'m--^');
