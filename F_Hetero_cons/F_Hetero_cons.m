...
str=[' -';' :';'--'; '-.'];
mkr = ['o';'+';'s';'^';'*';'d'];
pathname_tmp = 'F:\Research\MyPaper\GenQSGD_Journal\Simulation\F_Hetero_cons\Tmp\';
pathname_data = 'F:\Research\MyPaper\GenQSGD_Journal\Simulation\F_Hetero_cons\Data\';
rand_stop = 20;
...
for j = 1 : length(gamma_cons_list)
    ...
    % ------------ Plot 1 ---------
    p1 = plot(F_ratio_list, energy_line_cons);
...
%     % ------------ Plot 1 ---------
%     p1 = semilogy(F_ratio_list, energy_line_cons);
...
line2=semilogy(F_ratio_list, energy_line_cons,'r--o',F_ratio_list, energy_line_PM_fix,'b--+',F_ratio_list, energy_line_FedAvg_fix,'g--s',F_ratio_list, energy_line_PR_fix,'m--^');
